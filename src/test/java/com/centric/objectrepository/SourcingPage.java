...
public class SourcingPage  extends Commonactions{
	...
	@FindBy(xpath="(//table[@data-csi-automation='plugin-SupplierRequest-Quotes-ToolbarNewActions']/tbody/tr/td[2])[1]")
	...
	@FindBy(xpath="(//span[contains(@data-csi-automation,'filter-SupplierRequest-Quotes-Node Name:Child:__Parent__/Child:Supplier')]/span)[1]")
	...
	@FindBy(xpath="//div[contains(@class,'SupplierRequest-Quotes')]//div[contains(@data-dojo-attach-event,'QueryMessageCount')]")
